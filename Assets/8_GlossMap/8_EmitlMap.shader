Shader "MyShaders/8 - Emit Map" {
	Properties {
		...
		_EmitStrength ("Emission Strength", Range(0, 2)) = 0
	...
	SubShader {
		Pass {
			...
			float4 frag(vertexOutput i) : COLOR
			{
				...
				float3 lightFinal = rimLighting + diffuseReflection + (tex.a * specularReflection) + (texE.xyz * _EmitStrength) + UNITY_LIGHTMODEL_AMBIENT.xyz;
